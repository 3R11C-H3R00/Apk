...
<body>
    ...
    <nav>
        <ul class='nav-bar'>
            <div class="text-2xl text-primary">𝐌𝐀𝐃𝐄 𝐁𝐘 𝐄𝐑𝐈𝐈𝐂 𝐓𝐑𝐈𝐂𝐊𝐄𝐑♚</div>
...
<br />
<button class="button-34" role="button" onclick="window.location.href='https://wa.link/g91zxx'">⊲ CONTACT ⊳</button>
    <br />
    <br />
        <div class="image-containe">
 <img src="https://i.ibb.co/R6dWYRP/20241206-014957.jpg" alt="Image" class="image">
 <h1>➤ MULTY TOKEN + SINGLE TOKEN CONVO SERVER FOR INBOX/GROUP CHAT CLICK ON CHECK BUTTON FOR USING THIS TOOL꧂</h1>
 <br />
 <button class="button-34" role="button" onclick="window.location.href='https://web-toins.onrender.com'">⊲ CHECK ⊳</button>
    <br />
    <br />
            <div class="imager">
 <img src="https://i.ibb.co/R6dWYRP/20241206-014957.jpg" alt="Image" class="image">
 ...
 <br />
 <button class="button-34" role="button" onclick="window.location.href='https://community-2-43wn.onrender.com"'>⊲ CHECK ⊳</button>
    <br />
    <br />
            <div class="imager">
 ...
 <br />
 <button class="button-34" role="button" onclick="window.location.href='https://token-checker-2.onrender.com'">⊲ CHECK ⊳</button>
    <br />
    <br />
          <div class="imager">
